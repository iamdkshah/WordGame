...
import com.example.wordgame.adapters.CharactersAdapter;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void showWord(int i){
        CharactersAdapter charactersAdapter = new CharactersAdapter(MainActivity.this, shuffleWords(i),editWord);
